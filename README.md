# Minecraft Launchers list

The purpose of this repo is to archive Minecraft launchers at all. Launchers that allows you to add a Cracked account but requires you to add a Premium first, will fit into Premium.
...
| Prism Launcher | ✅ Yes | [Github link](https://github.com/PrismLauncher/PrismLauncher/releases/tag/9.1)/[Website](https://prismlauncher.org/download/windows/) | Fork from MultiMC, with more features and support (includes mod, modpacks, texture and more downloadable on the launcher itself), also a continuation of PolyMC. EDIT: Allows Cracked once a Premium account is added |
...
| --- | --- | --- | --- | --- |
| Amethyst | Android & IOS | ✅ Yes | [Github (Android ver)](https://github.com/AngelAuraMC/Amethyst-Android)/[Github (IOS ver)](https://github.com/AngelAuraMC/Amethyst-iOS)/[Website](https://wiki.angelauramc.dev/) | Maintained fork of PojavLauncher (continuation), currently, nothing really new. |
| PojavLauncher | Android & IOS | ✅ Yes | [Github (Android ver)](https://github.com/PojavLauncherTeam/PojavLauncher/releases/tag/foxglo)/[Website](https://pojavlauncherteam.github.io)/[Playstore](https://play.google.com/store/apps/details?id=net.kdt.pojavlaunch)/[Github (IOS ver)](https://github.com/PojavLauncherTeam/PojavLauncher_iOS/releases/tag/v2.2) | [DEPRECATED] Trustable, good reputation, well configurable and much more, recommendable. |
...
| Glowsquid | ✅ Yes | [Github link](https://github.com/glowsquid-launcher/glowsquid) | Seems more compatible with NixOS (Linux), but requires you to build the Launcher first, no pre-built binaries. | :x: No |
